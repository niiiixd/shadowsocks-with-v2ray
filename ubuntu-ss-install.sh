...
print_ss_info(){
    ...
    echo "Your Plugin options   :  server;tls;cert=/etc/letsencrypt/live/$domain/fullchain.pem;key=/etc/letsencrypt/live/$domain/privkey.pem;host=$domain;loglevel=none"
    echo "Enjoy it!"
}
set_password
set_domain
